    ...
    return function (container) {
      ...
      */
      ...
      var getNoStatHtml = function () {
        ...
        html += ' <p>dataNumber: <input class="data_number" value="50" />(total: ' + matrix.length + ')</p>';
      ...
      var getConfigTabs = function (stat) {
        ...
        <div class="tabbable" id="configTabs"> \
          <ul class="nav nav-tabs" id="configNavTabs"> \
            <li class="active"><a href="#noStatContent" data-toggle="tab">no stat</a></li> \
            <li><a href="#statContent" data-toggle="tab">statistic</a></li> \
          </ul> \
     \
  ...
  Land("aside", function (view) {
    ...
    App.ready('filter_change', function (val) {
      if (val.newVal === "dataChanged") {
        var html = '<ul class="nav nav-pills"> <li><a href="#">All</a></li> <li ><a href="#">None</a></li> </ul>';
